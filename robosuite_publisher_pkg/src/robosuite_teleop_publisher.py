...
if __name__ == "__main__":
    ...
    filtered_args = filter_ros_args(sys.argv[1:])
    ...
    rospy.init_node('teleop_publisher', anonymous=True)
    ...
    while True:
        ...
        while True:
            ...
            msg = Array()
            msg.data = action.tolist()  # Convert numpy array to Python list
